...
exports.BaseDitaRenderer = void 0;
...
class BaseDitaRenderer {
    constructor() {
        ...
        this.md.renderer.rules.fence = (tokens, idx) => `<codeblock>${this.md.utils.escapeHtml(tokens[idx].content.trim())}</codeblock>`;
    }
}
exports.BaseDitaRenderer = BaseDitaRenderer;
